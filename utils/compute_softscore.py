"""
Soft score calculation and processing taken from Hengyuan Hu (https://github.com/hengyuan-hu)
Ref: https://github.com/hengyuan-hu/bottom-up-attention-vqa
Licensed under the GNU General Public License v3.0.
Modifications made to remove logging and directory checking and replace cPickle with pickle

Based on findings in Tips and Tricks for Visual Question Answering: Learnings from the 2017 Challenge
